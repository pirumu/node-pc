...
export const getTcpConfig = (): TcpConfig => {
  return {
    publisher: {
      ...
      port: resolve('TCP_PUBLISHER_PORT', Number, { default: 3001 }),
    },
    consumer: {
      host: resolve('TCP_CONSUMER_HOST', String, { default: '192.168.0.107' }),
      port: resolve('TCP_CONSUMER_PORT', Number, { default: 3001 }),
    },
  };
};
