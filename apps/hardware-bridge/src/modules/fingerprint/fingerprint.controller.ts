...
export class FingerprintController {
  private readonly _logger = new Logger(FingerprintController.name);
  constructor(private readonly _fingerprintService: FingerprintService) {}
  ...
  public async verify(@TracingID({ transport: Transport.TCP }) tracingId: string): Promise<IContextualResponse> {
    ...
    return this._fingerprintService.verify();
  }
}
